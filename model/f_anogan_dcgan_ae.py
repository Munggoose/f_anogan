...
#  latent_dim=100, ngf = 28, channels=1,
...
class F_anogan_dcgan_ae(BaseModel):
    def __init__(self,latent_dim=100, ngf = 28, in_channels=1, bias =True):
        super(F_anogan_dcgan_ae,self).__init__()
        ...
        self.g_layer = Generator(self.latent_dim, self.ndf, self.channels,bias = self.bias)
        self.d_layer = Discriminator(self.latent_dim, self.ndf, self.channels,bias = self.bias)
        self.encoder = Encoder(self.latent_dim, self.ndf, self.channels,bias = self.bias)
